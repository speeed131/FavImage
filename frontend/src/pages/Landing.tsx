...
ランダムに出てくる画像は意外なお気に入り画像があるかも。

FavImage は ワクワクしながらお気に入りの画像を探せるアプリです。
...
使い方
１，まずは登録！
名前とパスワードだけで簡単に登録できます。

２，画像がランダムに表示されていきます。
ジャンルに関わらず表示されていきます！ 今後はジャンル別で画像が表示できる機能も開発中です。

３, お気に入りしたい画像にはハートをクリック！ それ以外はバツをクリックしましょう。
もし間違えてバツを押しても前の画像に戻れます。


４, お気に入り画像ページからダウンロードサイトに飛べる！
自分がお気に入り登録した画像が一覧で表示されます。そこからダウンロードページに飛ぶことができます。
